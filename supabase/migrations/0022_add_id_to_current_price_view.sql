-- Migration 0022: Add id to product_supplier_current_price view
-- This enables edit/delete operations on prices

-- Drop dependent views first
DROP VIEW IF EXISTS product_price_summary CASCADE;
DROP VIEW IF EXISTS product_supplier_current_price CASCADE;

-- Recreate product_supplier_current_price view with id
...
COMMENT ON VIEW product_supplier_current_price IS 'מחירים עדכניים לכל מוצר-ספק, כולל id לעריכה ומחיקה';
